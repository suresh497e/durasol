...
export default function MpptPcu2500Page() {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Product Detail */}
      <ProductDetail
        title="Hybrid MPPT Inverter"
        description="Hybrid MPPT or Maximum Power Point Tracking is the algorithm that included in charge controllers used for extracting maximum available power from PV module under certain conditions."
        subtitle="High-Efficiency Solar Charge Controller & Inverter"
        image={
          <Image
            src="/products/hybrid_mppt.jpg"
       ...
       /* features={[
        ...
        downloads={[
          { name: "Technical Brochure", url: "/products/pdf/hybridmpptpdf.pdf" },
