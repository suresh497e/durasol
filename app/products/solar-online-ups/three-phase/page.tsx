...
export default function ThreePhasePage() {
  return (
    <main className="min-h-screen">
      ...
      <ProductDetail
        title="Solar Online UPS (Three-Phase) Reliable & Efficient Power Backup | Durasol Energi"
        description="Solar Online UPS (Three-Phase) – an advanced combination of an inverter and solar charge controller. It efficiently harnesses solar power, stores energy in batteries, and ensures uninterrupted power with zero changeover time. Ideal for reliable backup power solutions."
        subtitle="1-10kVA Solar Compatible Online UPS Systems"
        image={
          <Image
            src="/products/three_phase.png"
